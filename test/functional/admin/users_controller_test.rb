...
class Admin::UsersControllerTest < ActionController::TestCase
  ...
  test "should create admin_user" do
    assert_difference('Admin::User.count') do
      post :create, admin_user: { created_at: @admin_user.created_at, login: @admin_user.login, mail: @admin_user.mail, password: @admin_user.password, username: @admin_user.username }
    end
  ...
  test "should update admin_user" do
    put :update, id: @admin_user, admin_user: { created_at: @admin_user.created_at, login: @admin_user.login, mail: @admin_user.mail, password: @admin_user.password, username: @admin_user.username }
    assert_redirected_to admin_user_path(assigns(:admin_user))
  end
